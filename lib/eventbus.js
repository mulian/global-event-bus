(function() {
  ...
  module.exports = EventBus = (function() {
      ...
      return (function(_this) {
        return function(channel, arg) {
          ...
          if (arg instanceof Function) {
            return _this.onFunction(chan, arg, thisArg, onReady);
          } else if (arg instanceof Object) {
            return _this.onObject(chan, arg, thisArg, onReady);
          } else {
            if (_this.debug) {
    ...
    EventBus.prototype.onFunction = function(chan, func, thisArg, onReady) {
      chan.obj[chan.name] = this.createFunction(func, thisArg, onReady);
      return function() {
        return delete chan.obj[chan.name];
      };
    };

    EventBus.prototype.onObject = function(chan, functions, thisArg, onReady) {
      var key, obj, val;
      ...
      for (key in functions) {
        ...
        if (val instanceof Function) {
          obj[key] = this.createFunction(val, thisArg, onReady);
        }
      }
      return function() {
        var results;
    ...
    EventBus.prototype.createFunction = function(func, thisArg, onReady) {
      return (function(_this) {
        return function() {
          var args, ref;
          args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
